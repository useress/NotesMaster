...
class Ui_window(object):
    def setupUi(self, window):  # установка параметров окна
        ...
        #self.gridLayout.setContentsMargins(-1, -1, -1, 600)
...
'border-radius:10px')
        ...
        #self.notes_layout = QtWidgets.QVBoxLayout()  # Создаем вертикальный макет для заметок
        #self.gridLayout.addLayout(self.notes_layout, 1, 0, 1, 1)
    ...
    def refresh_window(self):
        ...
        # Создать новый экземпляр главного окна
        new_window = QtWidgets.QMainWindow()

        # Вызвать метод setupUi для нового окна, чтобы настроить его интерфейс
        ui1 = Ui_window()
        ui1.setupUi(new_window)
